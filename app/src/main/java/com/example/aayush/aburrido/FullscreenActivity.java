...
//        });
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //initLogin();
                Intent i = new Intent(FullscreenActivity.this,ListActivity.class);
                startActivity(i);
            }
        });
        ...
        skipTextView = (TextView) findViewById(R.id.signUpTextView);
        skipTextView.setPaintFlags(skipTextView.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        Linkify.addLinks(skipTextView, Linkify.ALL);
